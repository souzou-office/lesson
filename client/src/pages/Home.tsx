    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white shadow-sm">
        <div className="container flex items-center justify-between h-20">
          <div className="flex items-center gap-2">
            <img src="/logo.png" alt="司法書士法人そうぞう" className="h-12 w-auto" />
          </div>
        ...
        <div className="container max-w-6xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div className="flex justify-center">
              <img src="/benefits-illustration-premium.png" alt="メリット" className="w-4/5 md:w-full max-w-md rounded-lg" />
            </div>
          </div>
        ...
        <div className="container max-w-6xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            <div className="flex justify-center order-2 md:order-1">
              <img src="/features-illustration-premium.png" alt="特徴" className="w-4/5 md:w-full max-w-md rounded-lg" />
            </div>
      ...
      <section className="section-padding bg-gradient-to-br from-green-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="container max-w-6xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div className="flex justify-center">
              <img src="/target-illustration-premium.png" alt="おすすめ" className="w-4/5 md:w-full max-w-md rounded-lg" />
            </div>
          </div>
      ...
      <section id="support" className="section-padding bg-gradient-to-br from-purple-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="container max-w-6xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            <div className="flex justify-center order-2 md:order-1">
              <img src="/support-illustration-premium.png" alt="サポート" className="w-4/5 md:w-full max-w-md rounded-lg" />
            </div>
            <div className="order-1 md:order-2">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                受講後のサポートサービス
